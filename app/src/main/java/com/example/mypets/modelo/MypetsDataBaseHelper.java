...
public class MypetsDataBaseHelper extends SQLiteOpenHelper {

    private static final String DB_NAME="mypets.db";
    private static final int DB_VERSION=1;

    public MypetsDataBaseHelper(Context context) {
    ...
    public List<Producto> listaProductos(){
        ...
        Cursor cursor=db.query("PRODUCTOS",
                new String[]{"NOMBRE","CANTIDAD","UNIDAD","ESTADO"},null,null,null,
                null,null);
        cursor.moveToFirst();
        int estadoInt;
    ...
    public String cambiarEstado(Producto p){
        ...
        // solo hay que cambiarlo en la DB
